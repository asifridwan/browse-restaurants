...
export default function BrowseRestaurants({username, userID, onSaved, onLogout}) {
    ...
    useEffect(() => {
        axios.get('https://browse-restaurants-api.herokuapp.com/restaurants').then(res => setRestaurants(res.data))
    }, []);
    ...
    function ConfirmAdd() {
        axios.post('https://browse-restaurants-api.herokuapp.com/add', {
            name: collectionName,
            old_id: collectionID,
            user_id: userID,
            res_id: restaurantID,
